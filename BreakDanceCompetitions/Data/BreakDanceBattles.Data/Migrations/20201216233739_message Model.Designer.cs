...
namespace BreakDanceBattles.Data.Migrations
{
    ...
    [Migration("20201216233739_message Model")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BreakDanceBattles.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("BreakDanceBattles.Data.Models.CompetitionCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BreakDanceBattles.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BreakDanceBattles.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BreakDanceBattles.Data.Models.CompetitionCategory", b =>
                {
                    b.HasOne("BreakDanceBattles.Data.Models.Category", "Category")
                        .WithMany("Competitions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BreakDanceBattles.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BreakDanceBattles.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
